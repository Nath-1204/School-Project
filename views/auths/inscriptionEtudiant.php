    ...
    <div id="container">
        ...
        <div id="content">
            <form action="" method="post" style="width: 70%; margin-left:15%;text-align:center">
                ...
                <div class="form-group">
                    <input type="text" style="text-align: center;" name="niveau" placeholder="Votre niveau" id="niveau" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <h4>Vous avez déjà un compte? <a href="connexionEtudiant.php" id="lien_connexion" style="color: #0a58ca;">Cliquer ici pour vous connecter</a></h4>
            </form>
